			...
			<div class="container" id="main-container">
				<div class="left-sidebar">
					<div class="content">
						...
						$this -> load -> view('video/homePlayer1.php');

						/*Random Video Carosuel*/
						$this -> load -> view('home/thumbnailScroll1.php');
						?>
					</div>
				</div>
						...
						<div class="content">
							...
							<div class="sub-content">
								...
								<span style="float: left; width: 60%; margin-left: 3%;"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Nam cursus. Morbi ut mi. Nullam enim leo,
									egestas id, condimentum at, laoreet mattis, massa. Sed eleifend nonummy diam. </span>
							</div>
