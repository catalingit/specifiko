...
<head>
	...
	<!-- Dropdown Menu -->
	<link rel="stylesheet" href="<?=serverAssets();?>css/menu_style.css">
    ...
    <script src="<?=serverAssets();?>js/jquery.dropdownPlain.js"></script>
	<!-- Featured Video Block -->
    <script src="<?=serverAssets();?>js/homeVideoLoader.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="<?=serverAssets();?>css/skin.css">
</head>
