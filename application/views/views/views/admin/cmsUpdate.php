    ...
    <form id="update-page-form" method="post">
        ...
        <table class="detail-view" id="yw0">
            ...
            <tr class="even">
                ...
                <td>
                    <div class="summernote"><?php echo $page['bodytxt']; ?></textarea>
                </td>
            </tr>
            ...
            <tr class="even">
                ...
                <td>
                    <div class="summernote"><?php echo $page['ch_bodytxt']; ?></textarea>
                </td>
            </tr>
            ...
            <tr class="even">
                ...
                <td>
                    <div class="summernote"><?php echo $page['jp_bodytxt']; ?></textarea>
                </td>
            </tr>
